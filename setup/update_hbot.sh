...
execute_docker () {
 ...
 do
   ...
   --network host \
   --name ${INSTANCES[$j]} \
   --mount "type=bind,source=${FOLDERS[$j]}/hummingbot_conf,destination=/home/hummingbot/conf/" \
   --mount "type=bind,source=${FOLDERS[$j]}/hummingbot_logs,destination=/home/hummingbot/logs/" \
   --mount "type=bind,source=${FOLDERS[$j]}/hummingbot_data,destination=/home/hummingbot/data/" \
   --mount "type=bind,source=${FOLDERS[$j]}/hummingbot_scripts,destination=/home/hummingbot/scripts/" \
   --mount "type=bind,source=${FOLDERS[$j]}/hummingbot_pmm_scripts,destination=/home/hummingbot/pmm_scripts/" \
   ...
   --mount "type=bind,source=${FOLDERS[$j]}/gateway_logs,destination=/home/hummingbot/gateway_logs/" \
